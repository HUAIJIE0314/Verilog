	...
	always@(posedge iclkSys or negedge irst_n)begin
		if(!irst_n)fstate <= IDLE;
			...
			case(fstate)
				...
				MAKEEN:begin
					if(counter == cntStop)fstate <= FINISH;
					else                  fstate <= MAKEEN;
				end
				FINISH:begin
					if(counter == cntStop)fstate <= IDLE;
					else                  fstate <= FINISH;
				end
				default:fstate <= IDLE;
			endcase
	...
	always@(posedge iclkSys or negedge irst_n)begin
		if(!irst_n)begin
			...
			case(fstate)
				...
				MAKEEN:begin
					counterEN <= 1'b1;
					if(counter > cntRise && counter <cntFall)olcdEN <= 1'b1;
					else                                     olcdEN <= 1'b0;
					olcdReady <= 1'b0;
				end
				FINISH:begin
					counterEN <= 1'b1;
					olcdEN    <= 1'b0;
					if(counter == cntStop)olcdReady <= 1'b1;
					else                  olcdReady <= 1'b0;
				end
				default:begin
					counterEN <= 1'b0;
...
![LCD_control%20eb4469f82b8f416da406d7efb9dca2c1/Untitled.png](LCD_control%20eb4469f82b8f416da406d7efb9dca2c1/Untitled.png)

## Compilation Report

![LCD_control%20eb4469f82b8f416da406d7efb9dca2c1/Untitled%201.png](LCD_control%20eb4469f82b8f416da406d7efb9dca2c1/Untitled%201.png)

hahahahaha

## RTL Viewer

![LCD_control%20eb4469f82b8f416da406d7efb9dca2c1/Untitled%202.png](LCD_control%20eb4469f82b8f416da406d7efb9dca2c1/Untitled%202.png)
