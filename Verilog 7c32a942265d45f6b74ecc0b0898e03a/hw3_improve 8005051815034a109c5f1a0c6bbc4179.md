...
`include "./I2C/I2C_control_adjustable.v"
	...
	always@(posedge clk_sys or negedge rst_n)begin
		if(!rst_n)cnt_I2C <= 9'd0;
			...
			if(cnt_I2C<9'd499)cnt_I2C <= cnt_I2C + 9'd1;//0-99
			else              cnt_I2C <= 9'd0;
		end
	end
	/*---------I2C tick---------*/
	...
	always@(posedge clk_sys or negedge rst_n)begin
		if(!rst_n)tick_I2C_neg <= 1'b0;
			...
			if(cnt_I2C==9'd248)tick_I2C_neg <= 1'b1;
	...
	always@(posedge clk_sys or negedge rst_n)begin
		if(!rst_n)SCLK_100k <= 1'b0;
			...
			if(cnt_I2C==9'd150)     SCLK_100k <= 1'b0;//499 400
			else if(cnt_I2C==9'd350)SCLK_100k <= 1'b1;//999 600 0 249 250 499
...
![hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled.png](hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled.png)

## RTL Viewer

![hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%201.png](hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%201.png)

![hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%202.png](hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%202.png)

![hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%203.png](hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%203.png)

![hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%204.png](hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%204.png)

## State Machine

![hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%205.png](hw3_improve%208005051815034a109c5f1a0c6bbc4179/Untitled%205.png)
